...
`,
      errors: [
        {
          message:
            "when importing to same package (@app/thread), use relative imports (./)",
          line: 1,
          column: 1,
...
`,
      errors: [
        {
          message:
            "when importing to same package (@app/ui/membership-selector), use relative imports (./membership-selector)",
          line: 1,
          column: 1,
          type: "ImportDeclaration"
        }
...
`,
      errors: [
        {
          message:
            "when importing to same package (@app/ui/tables/asset-status-table-cell-dropdown), use relative imports (./asset-status-table-cell-dropdown)",
          line: 1,
          column: 1,
          type: "ImportDeclaration"
        }
...
`,
      errors: [
        {
          message:
            "when importing to same package (@app/thread/component/some-component.js), use relative imports (./component/some-component.js)",
          line: 2,
          column: 3,
          type: "ImportDeclaration"
        }
...
`,
      errors: [
        {
          message:
            "when importing to same package (@app/ui/atoms/edit-button), use relative imports (../atoms/edit-button)",
          line: 2,
          column: 3,
          type: "ImportDeclaration"
        }
